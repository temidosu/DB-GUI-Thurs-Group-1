...
export class OthersProfile extends React.Component {
  ...
  componentDidMount() {
    if (this.props.match.params.userid) {
      this.repo.getUserInfo(this.props.match.params.userid).then((data) => {
        console.log(data);
        this.setState({
  ...
  displayPhone() {
    ...
    phoneNum += this.state.phone
      .toString()
      .substring(6, this.state.phone.length);
    return phoneNum;
  }
  render() {
          ...
          <div class="card mt-5">
            ...
            <div class="card-body">
              <img
                ...
                class="w-10 h-10 float-left mr-3"
              ></img>
              ...
              <p>
                {" "}
                Email: {this.state.email} Phone: {this.displayPhone()}{" "}
              </p>
            </div>
          </div>
        </div>
        ...
        return (
          ...
          <div class="container">
            ...
            <div class="card mt-5">
              ...
              <ReviewForm
                reviewedID={this.props.match.params.userid}
                reviewedFirstName={this.state.firstName}
                reviewedLastName={this.state.lastName}
                onReviewAdded={(newReview) => this.addNewReview(newReview)}
              />
            </div>
            {/* <div class = "card mt-5"> 
                            <div class="card-header">
