...
export class ProjectRequestButton extends React.Component{
    ...
    render()
    {
        return(
        <>
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#projectModal">Create a Project Request</button>
